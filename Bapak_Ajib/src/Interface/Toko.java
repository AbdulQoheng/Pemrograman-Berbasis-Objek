 ...
 * @author qoheng
 */
public class Toko extends AbsJualBeli implements Mobil, Motor{
    ...
    public Toko(String merkMobil, String warnaMobil, String merkMotor, String warnaMotor){
    ...
    public void keterangan(){
        ...
        System.out.println("dari Supplier "+getSupplier()+" sebanyak "+getJumlah());
        System.out.println("dengan harga satauan "+getHarga_satuan()+".");
        System.out.println("Uang yang di keluarkan Toko adalah "+getHarga_total()+".");
        System.out.println("stok "+getBarang()+" bertambah "+getJumlah());
        System.out.println("Dalam menjalankan usahanya, ");
        System.out.println("Toko memiliki Mobil dengan merk "+getMerkMobil()+", warna "+getWarnaMobil());
